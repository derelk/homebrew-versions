...
class Python26 < Formula
  ...
  head 'http://hg.python.org/cpython', :using => :hg, :branch => '2.6'
  ...
  skip_clean 'bin/easy_install', 'bin/easy_install-2.6'
  ...
  patch :p0 do
    url "https://gist.githubusercontent.com/derelk/10072239/raw/cca0cec670474ab980e4c71f9f03859a4f288a94/CVE-2014-1912-26.patch"
    sha1 "109d54c2515d4622194712c211721cd56989e25d"
  end

  # Patch to disable the search for Tk.framework, since Homebrew's Tk is
  # a plain unix build. Remove `-lX11`, too because our Tk is "AquaTk".
  #patch :D#ATA if build.with? "brewed-tk"

  def lib_cellar
    prefix/"Frameworks/Python.framework/Versions/2.6/lib/python2.6"
  end
  ...
  def install
    ...
    # Patch framework install problem with 2.6
    # -lSystemStubs doesn't work after 10.4
    inreplace './configure', ' -lSystemStubs', ''
  ...
  def post_install
    ...
    # minor updates, such as going from 2.6.0 to 2.6.1:

    # Create a site-packages in HOMEBREW_PREFIX/lib/python2.6/site-packages
    ...
    %w[pip2.6 easy_install-2.6].each do |e|
  ...
  def sitecustomize
    <<-EOF.undent
      ...
      if sys.version_info[0] != 2:
          ...
          opt_executable = '#{opt_bin}/python2.6'
          if os.path.commonprefix([os.path.realpath(e) for e in [opt_executable, sys.executable]]).startswith('#{rack}'):
              ...
              sys.path = [ p for p in sys.path
                           if (not p.startswith('/System') and
                               not p.startswith('#{HOMEBREW_PREFIX}/lib/python2.6') and
              ...
              try:
                  ...
                  build_time_vars['LINKFORSHARED'] = '-u _PyMac_Error #{opt_prefix}/Frameworks/Python.framework/Versions/2.6/Python'
              except:
